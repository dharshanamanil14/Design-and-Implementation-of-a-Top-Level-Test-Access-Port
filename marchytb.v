...
begin
	...
	run_march_y(2'b11, "Normal Operation");
	run_march_y(2'b00, "Stuck-at faults detection");
	run_march_y(2'b01, "Transition faults detection");
	run_march_y(2'b10, "Inversion coupling fault detection");
...
begin
	#5000;
	$display("Timeout: March Y test did not complete");
	$finish;
end
